...
function PublicSitePage({ navigate, path }) {
  ...
  return (
    <main className="public-site" ref={revealRef}>
      ...
      <section id="garanties" className="public-band garanties-section">
        <div className="reveal">
          <span className="eyebrow">Garanties et remboursement</span>
          <h2>4 couches de sécurité. Zéro risque pour la banque.</h2>
          <p className="public-subtitle">FresCoop ne se contente pas de scorer — nous sécurisons le prêt de bout en bout avec un système de remboursement automatisé que l'agriculteur ne peut pas contourner.</p>
        </div>

        <div className="garanties-grid">
          <article className="reveal garantie-card garantie-card--1">
            <div className="garantie-card__number">1</div>
            <div className="garantie-card__content">
              <h3>Prélèvement instantané à la source</h3>
              <p className="garantie-card__subtitle">Pas mensuel. À chaque transaction.</p>
              <div className="garantie-card__flow">
                <div className="garantie-flow-step">Acheteur paie 100 000 FCFA</div>
                <div className="garantie-flow-arrow"><ArrowRight size={16} /></div>
                <div className="garantie-flow-step highlight">FresCoop intercepte le paiement</div>
                <div className="garantie-flow-arrow"><ArrowRight size={16} /></div>
                <div className="garantie-flow-step">25% retenu = 25 000 FCFA</div>
                <div className="garantie-flow-arrow"><ArrowRight size={16} /></div>
                <div className="garantie-flow-step">Agriculteur reçoit 75 000 FCFA</div>
              </div>
              <p className="garantie-card__key">L'agriculteur ne voit jamais les 100%. Le prélèvement est invisible et automatique.</p>
            </div>
          </article>

          <article className="reveal garantie-card garantie-card--2">
            <div className="garantie-card__number">2</div>
            <div className="garantie-card__content">
              <h3>Taux de prélèvement progressif</h3>
              <p className="garantie-card__subtitle">Protège les petits revenus, accélère quand ça va bien.</p>
              <div className="garantie-taux-grid">
                <div className="garantie-taux-item">
                  <span className="garantie-taux-range">&lt; 75 000 FCFA</span>
                  <strong className="garantie-taux-pct pause">0%</strong>
                  <em>Pause — protection du minimum vital</em>
                </div>
                <div className="garantie-taux-item">
                  <span className="garantie-taux-range">75K – 150K</span>
                  <strong className="garantie-taux-pct light">15%</strong>
                  <em>Taux léger</em>
                </div>
                <div className="garantie-taux-item">
                  <span className="garantie-taux-range">150K – 300K</span>
                  <strong className="garantie-taux-pct normal">25%</strong>
                  <em>Remboursement normal</em>
                </div>
                <div className="garantie-taux-item">
                  <span className="garantie-taux-range">&gt; 300 000</span>
                  <strong className="garantie-taux-pct fast">30%</strong>
                  <em>Remboursement accéléré</em>
                </div>
              </div>
            </div>
          </article>

          <article className="reveal garantie-card garantie-card--3">
            <div className="garantie-card__number">3</div>
            <div className="garantie-card__content">
              <h3>Caution solidaire digitale</h3>
              <p className="garantie-card__subtitle">Le mécanisme Grameen Bank adapté au digital.</p>
              <ul className="garantie-list">
                <li><CheckCircle2 size={16} /> Groupe de 5 agriculteurs qui se cautionnent</li>
                <li><CheckCircle2 size={16} /> Si un défaut : le score des 4 autres est impacté</li>
                <li><CheckCircle2 size={16} /> Pression sociale = taux de remboursement de 98%</li>
                <li><CheckCircle2 size={16} /> Les groupes se forment naturellement (même village, même coopérative)</li>
              </ul>
            </div>
          </article>

          <article className="reveal garantie-card garantie-card--4">
            <div className="garantie-card__number">4</div>
            <div className="garantie-card__content">
              <h3>Fonds de garantie mutualisé</h3>
              <p className="garantie-card__subtitle">La banque est couverte même en cas de défaut.</p>
              <ul className="garantie-list">
                <li><CheckCircle2 size={16} /> 2% de chaque transaction alimente le fonds</li>
                <li><CheckCircle2 size={16} /> Couvre jusqu'à 20% des impayés du portefeuille</li>
                <li><CheckCircle2 size={16} /> Plus le volume grandit, plus le fonds est solide</li>
                <li><CheckCircle2 size={16} /> La banque prête sans risque — FresCoop absorbe le défaut</li>
              </ul>
            </div>
          </article>
        </div>

        <div className="garanties-result reveal">
          <div className="garanties-result__item">
            <strong>Taux de défaut estimé</strong>
            <span>&lt; 2%</span>
            <em>vs 15-25% en microfinance classique</em>
          </div>
          <div className="garanties-result__item">
            <strong>Remboursement moyen</strong>
            <span>6-8 mois</span>
            <em>Sans jamais mettre l'agriculteur en difficulté</em>
          </div>
          <div className="garanties-result__item">
            <strong>Couverture banque</strong>
            <span>100%</span>
            <em>Fonds de garantie + caution solidaire</em>
          </div>
        </div>
      </section>
